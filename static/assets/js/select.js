...
(function () {
  ...
  ((i = (function () {
    ...
    var e, s, r, o, n;
    for (s = new i(), r = 0, o = (n = t.childNodes).length; r < o; r++)
      (e = n[r]), s.add_node(e);
    return s.parsed;
  }),
    (e = (function () {
      ...
      return (
        ...
        (t.prototype.results_option_build = function (t) {
          var e, s, i, r, o, n, l;
          for (
            e = "", r = 0, o = 0, n = (l = this.results_data).length;
            o < n &&
            ((i = ""),
            "" !==
              (i = (s = l[o]).group
                ? this.result_add_group(s)
                : this.result_add_option(s)) && (r++, (e += i)),
        ...
        (t.prototype.reset_single_select_options = function () {
          var t, e, s, i, r;
          for (r = [], e = 0, s = (i = this.results_data).length; e < s; e++)
            (t = i[e]).selected ? r.push((t.selected = !1)) : r.push(void 0);
          return r;
        }),
        ...
        (t.prototype.winnow_results = function () {
          ...
          for (
            this.no_results_clear(),
              ...
              h = new RegExp(t, "i"),
              s = this.get_search_regex(t),
              c = 0,
              a = (_ = this.results_data).length;
            c < a;
            c++
          )
            ((e = _[c]).search_match = !1),
              (r = null),
              this.include_option_in_results(e) &&
                (e.group && ((e.group_match = !1), (e.active_options = 0)),
                null != e.group_array_index &&
                  this.results_data[e.group_array_index] &&
                  (0 ===
                    (r = this.results_data[e.group_array_index])
                      .active_options &&
                    r.search_match &&
                    (i += 1),
                  (r.active_options += 1)),
                ...
                (e.group && !this.group_search) ||
                  ((e.search_match = this.search_string_match(
                    e.search_text,
                    s,
                  )),
                  e.search_match && !e.group && (i += 1),
                  e.search_match
                    ? (o.length &&
                        ((n = e.search_text.search(h)),
                        (l =
                          e.search_text.substr(0, n + o.length) +
                          "</em>" +
                          e.search_text.substr(n + o.length)),
                        (e.search_text =
                          l.substr(0, n) + "<em>" + l.substr(n))),
                      null != r && (r.group_match = !0))
                    : null != e.group_array_index &&
                      this.results_data[e.group_array_index].search_match &&
                      (e.search_match = !0)));
          return (
            this.result_clear_highlight(),
            i < 1 && o.length
        ...
        (t.prototype.get_search_regex = function (t) {
          ...
          return (
            ...
            (s = this.case_sensitive_search ? "" : "i"),
            new RegExp(e + t, s)
          );
        }),
        ...
        (t.prototype.choices_click = function (t) {
          if ((t.preventDefault(), !this.results_showing && !this.is_disabled))
            return this.results_show();
        }),
        (t.prototype.keyup_checker = function (t) {
          var e, s;
          switch (
            ((e = null != (s = t.which) ? s : t.keyCode),
      ...
      chosen: function (i) {
        return e.browser_is_supported()
          ? this.each(function (e) {
              var r, o;
              (o = (r = t(this)).data("chosen")),
                "destroy" !== i
                  ? o instanceof s || r.data("chosen", new s(this, i))
          ...
          if (t.length) {
            if (
              ...
              (e =
                ...
                this.result_highlight.outerHeight()) >= r)
            )
              ...
              this.max_selected_options <= this.choices_count()
                ...
                : (this.is_multiple
                  ...
                  this.is_multiple
                    ? this.choice_build(s)
                    : this.single_set_selected_text(this.choice_label(s)),
                  ((t.metaKey || t.ctrlKey) && this.is_multiple) ||
                    this.results_hide(),
                  this.show_search_field_default(),
                  (this.is_multiple ||
        ...
        (o.prototype.search_field_scale = function () {
          ...
          if (this.is_multiple) {
            for (
              ...
              r += (i = o[l]) + ":" + this.search_field.css(i) + ";";
            return (
              (e = t("<div />", { style: r })).text(this.search_field.val()),
              t("body").append(e),
              (n = e.width() + 25),
              e.remove(),
              n > (s = this.container.outerWidth()) - 10 && (n = s - 10),
